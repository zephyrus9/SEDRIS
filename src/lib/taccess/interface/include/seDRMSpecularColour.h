...
/** @file seDRMSpecularColour.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMSpecularColour (258) class.
*/

#ifndef _seDRMSpecularColour_h
#define _seDRMSpecularColour_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMSpecularColour wraps the DRM <a href="../drm/classes/SpecularColour.htm">&lt;Specular_Colour&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMSpecularColour : public seDRMBase
{
public:
    ...
    seDRMSpecularColour( const seObject &other ) : seDRMBase(other) {}
