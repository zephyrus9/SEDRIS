...
/** @file seDRMImageLibrary.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMImageLibrary (110) class.
*/

#ifndef _seDRMImageLibrary_h
#define _seDRMImageLibrary_h

#include "seDRMLibrary.h"

namespace sedris {

/** seDRMImageLibrary wraps the DRM <a href="../drm/classes/ImageLibrary.htm">&lt;Image_Library&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMLibrary
*/
class seDRMImageLibrary : public seDRMLibrary
{
public:
    ...
    seDRMImageLibrary( const seObject &other ) : seDRMLibrary(other) {}
