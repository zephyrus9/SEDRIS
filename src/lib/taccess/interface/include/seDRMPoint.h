...
@brief Accessors to the seDRMPoint (179) class.
*/

#ifndef _seDRMPoint_h
#define _seDRMPoint_h

#include "seDRMPrimitiveGeometry.h"

namespace sedris {

/** seDRMPoint wraps the DRM <a href="../drm/classes/Point.htm">&lt;Point&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMPrimitiveGeometry
*/
class seDRMPoint : public seDRMPrimitiveGeometry
{
public:
    ...
    seDRMPoint( const seObject &other ) : seDRMPrimitiveGeometry(other) {}
