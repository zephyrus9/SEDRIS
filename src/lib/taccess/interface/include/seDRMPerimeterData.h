...
/** @file seDRMPerimeterData.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMPerimeterData (174) class.
*/

#ifndef _seDRMPerimeterData_h
#define _seDRMPerimeterData_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMPerimeterData wraps the DRM <a href="../drm/classes/PerimeterData.htm">&lt;Perimeter_Data&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMPerimeterData : public seDRMBase
{
public:
    ...
    seDRMPerimeterData( const seObject &other ) : seDRMBase(other) {}
