...
/** @file seDRMPropertyTable.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMPropertyTable (203) class.
*/

#ifndef _seDRMPropertyTable_h
#define _seDRMPropertyTable_h

#include "seDRMDataTable.h"

namespace sedris {

/** seDRMPropertyTable wraps the DRM <a href="../drm/classes/PropertyTable.htm">&lt;Property_Table&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMDataTable
*/
class seDRMPropertyTable : public seDRMDataTable
{
public:
    ...
    seDRMPropertyTable( const seObject &other ) : seDRMDataTable(other) {}
