...
/** @file seDRMTackPoint.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMTackPoint (272) class.
*/

#ifndef _seDRMTackPoint_h
#define _seDRMTackPoint_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMTackPoint wraps the DRM <a href="../drm/classes/TackPoint.htm">&lt;Tack_Point&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMTackPoint : public seDRMBase
{
public:
    ...
    seDRMTackPoint( const seObject &other ) : seDRMBase(other) {}
