...
/** @file seDRMPolyhedron.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMPolyhedron (183) class.
*/

#ifndef _seDRMPolyhedron_h
#define _seDRMPolyhedron_h

#include "seDRMVolumeGeometry.h"

namespace sedris {

/** seDRMPolyhedron wraps the DRM <a href="../drm/classes/Polyhedron.htm">&lt;Polyhedron&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMVolumeGeometry
*/
class seDRMPolyhedron : public seDRMVolumeGeometry
{
public:
    ...
    seDRMPolyhedron( const seObject &other ) : seDRMVolumeGeometry(other) {}
