...
/** @file seDRMAttachmentPoint.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMAttachmentPoint (13) class.
*/

#ifndef _seDRMAttachmentPoint_h
#define _seDRMAttachmentPoint_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMAttachmentPoint wraps the DRM <a href="../drm/classes/AttachmentPoint.htm">&lt;Attachment_Point&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMAttachmentPoint : public seDRMBase
{
public:

    /// Default constructor
    seDRMAttachmentPoint() {}

    /// Constructor for seDRM... class conversions
    seDRMAttachmentPoint( const seObject &other ) : seDRMBase(other) {}
