...
/** @file seDRMGeometryModel.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMGeometryModel (91) class.
*/

#ifndef _seDRMGeometryModel_h
#define _seDRMGeometryModel_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMGeometryModel wraps the DRM <a href="../drm/classes/GeometryModel.htm">&lt;Geometry_Model&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMGeometryModel : public seDRMBase
{
public:
    ...
    seDRMGeometryModel( const seObject &other ) : seDRMBase(other) {}
