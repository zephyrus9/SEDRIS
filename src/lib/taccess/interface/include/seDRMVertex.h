...
@brief Accessors to the seDRMVertex (299) class.
*/

#ifndef _seDRMVertex_h
#define _seDRMVertex_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMVertex wraps the DRM <a href="../drm/classes/Vertex.htm">&lt;Vertex&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMVertex : public seDRMBase
{
public:
    ...
    seDRMVertex( const seObject &other ) : seDRMBase(other) {}
