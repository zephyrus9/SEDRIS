...
/** @file seDRMPrimitiveColour.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMPrimitiveColour (187) class.
*/

#ifndef _seDRMPrimitiveColour_h
#define _seDRMPrimitiveColour_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMPrimitiveColour wraps the DRM <a href="../drm/classes/PrimitiveColour.htm">&lt;Primitive_Colour&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMPrimitiveColour : public seDRMBase
{
public:

    /// Default constructor
    seDRMPrimitiveColour() {}

    /// Constructor for seDRM... class conversions
    seDRMPrimitiveColour( const seObject &other ) : seDRMBase(other) {}
