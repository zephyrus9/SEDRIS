...
/** @file seDRMSoundLibrary.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMSoundLibrary (247) class.
*/

#ifndef _seDRMSoundLibrary_h
#define _seDRMSoundLibrary_h

#include "seDRMLibrary.h"

namespace sedris {

/** seDRMSoundLibrary wraps the DRM <a href="../drm/classes/SoundLibrary.htm">&lt;Sound_Library&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMLibrary
*/
class seDRMSoundLibrary : public seDRMLibrary
{
public:
    ...
    seDRMSoundLibrary( const seObject &other ) : seDRMLibrary(other) {}
