...
/** @file seDRMColourTable.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMColourTable (41) class.
*/

#ifndef _seDRMColourTable_h
#define _seDRMColourTable_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMColourTable wraps the DRM <a href="../drm/classes/ColourTable.htm">&lt;Colour_Table&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMColourTable : public seDRMBase
{
public:
    ...
    seDRMColourTable( const seObject &other ) : seDRMBase(other) {}
