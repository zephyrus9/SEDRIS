...
/** @file seDRMSymbolLibrary.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMSymbolLibrary (270) class.
*/

#ifndef _seDRMSymbolLibrary_h
#define _seDRMSymbolLibrary_h

#include "seDRMLibrary.h"

namespace sedris {

/** seDRMSymbolLibrary wraps the DRM <a href="../drm/classes/SymbolLibrary.htm">&lt;Symbol_Library&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMLibrary
*/
class seDRMSymbolLibrary : public seDRMLibrary
{
public:
    ...
    seDRMSymbolLibrary( const seObject &other ) : seDRMLibrary(other) {}
