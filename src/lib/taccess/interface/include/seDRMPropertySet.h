...
/** @file seDRMPropertySet.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMPropertySet (197) class.
*/

#ifndef _seDRMPropertySet_h
#define _seDRMPropertySet_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMPropertySet wraps the DRM <a href="../drm/classes/PropertySet.htm">&lt;Property_Set&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMPropertySet : public seDRMBase
{
public:
    ...
    seDRMPropertySet( const seObject &other ) : seDRMBase(other) {}
