...
@brief Accessors to the seDRMIcon (106) class.
*/
...
/** seDRMIcon wraps the DRM <a href="../drm/classes/Icon.htm">&lt;Icon&gt;</a> abstract class.
...
@see seDRMBase
*/
class seDRMIcon : public seDRMBase
{
public:
    ...
    seDRMIcon( const seObject &other ) : seDRMBase(other) {}
