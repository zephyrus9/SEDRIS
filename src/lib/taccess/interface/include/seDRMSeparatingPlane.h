...
/** @file seDRMSeparatingPlane.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMSeparatingPlane (237) class.
*/

#ifndef _seDRMSeparatingPlane_h
#define _seDRMSeparatingPlane_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMSeparatingPlane wraps the DRM <a href="../drm/classes/SeparatingPlane.htm">&lt;Separating_Plane&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMSeparatingPlane : public seDRMBase
{
public:

    /// Default constructor
    seDRMSeparatingPlane() {}

    /// Constructor for seDRM... class conversions
    seDRMSeparatingPlane( const seObject &other ) : seDRMBase(other) {}
