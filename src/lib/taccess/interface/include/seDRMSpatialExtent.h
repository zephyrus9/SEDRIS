...
/** @file seDRMSpatialExtent.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMSpatialExtent (251) class.
*/

#ifndef _seDRMSpatialExtent_h
#define _seDRMSpatialExtent_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMSpatialExtent wraps the DRM <a href="../drm/classes/SpatialExtent.htm">&lt;Spatial_Extent&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMSpatialExtent : public seDRMBase
{
public:
    ...
    seDRMSpatialExtent( const seObject &other ) : seDRMBase(other) {}
