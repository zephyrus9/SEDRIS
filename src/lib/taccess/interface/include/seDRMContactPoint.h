...
/** @file seDRMContactPoint.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMContactPoint (46) class.
*/

#ifndef _seDRMContactPoint_h
#define _seDRMContactPoint_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMContactPoint wraps the DRM <a href="../drm/classes/ContactPoint.htm">&lt;Contact_Point&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMContactPoint : public seDRMBase
{
public:
    ...
    seDRMContactPoint( const seObject &other ) : seDRMBase(other) {}
