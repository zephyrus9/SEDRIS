...
/** @file seDRMEmissiveColour.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMEmissiveColour (63) class.
*/

#ifndef _seDRMEmissiveColour_h
#define _seDRMEmissiveColour_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMEmissiveColour wraps the DRM <a href="../drm/classes/EmissiveColour.htm">&lt;Emissive_Colour&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMEmissiveColour : public seDRMBase
{
public:
    ...
    seDRMEmissiveColour( const seObject &other ) : seDRMBase(other) {}
