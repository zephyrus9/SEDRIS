...
/** @file seDRMAmbientColour.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMAmbientColour (8) class.
*/

#ifndef _seDRMAmbientColour_h
#define _seDRMAmbientColour_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMAmbientColour wraps the DRM <a href="../drm/classes/AmbientColour.htm">&lt;Ambient_Colour&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMAmbientColour : public seDRMBase
{
public:
    ...
    seDRMAmbientColour( const seObject &other ) : seDRMBase(other) {}
