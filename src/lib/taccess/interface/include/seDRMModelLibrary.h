...
/** @file seDRMModelLibrary.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMModelLibrary (163) class.
*/

#ifndef _seDRMModelLibrary_h
#define _seDRMModelLibrary_h

#include "seDRMLibrary.h"

namespace sedris {

/** seDRMModelLibrary wraps the DRM <a href="../drm/classes/ModelLibrary.htm">&lt;Model_Library&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMLibrary
*/
class seDRMModelLibrary : public seDRMLibrary
{
public:
    ...
    seDRMModelLibrary( const seObject &other ) : seDRMLibrary(other) {}
