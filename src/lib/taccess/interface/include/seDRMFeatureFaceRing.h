...
/** @file seDRMFeatureFaceRing.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMFeatureFaceRing (73) class.
*/

#ifndef _seDRMFeatureFaceRing_h
#define _seDRMFeatureFaceRing_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMFeatureFaceRing wraps the DRM <a href="../drm/classes/FeatureFaceRing.htm">&lt;Feature_Face_Ring&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMFeatureFaceRing : public seDRMBase
{
public:

    /// Default constructor
    seDRMFeatureFaceRing() {}

    /// Constructor for seDRM... class conversions
    seDRMFeatureFaceRing( const seObject &other ) : seDRMBase(other) {}
