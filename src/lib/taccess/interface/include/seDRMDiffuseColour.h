...
/** @file seDRMDiffuseColour.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMDiffuseColour (53) class.
*/

#ifndef _seDRMDiffuseColour_h
#define _seDRMDiffuseColour_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMDiffuseColour wraps the DRM <a href="../drm/classes/DiffuseColour.htm">&lt;Diffuse_Colour&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMDiffuseColour : public seDRMBase
{
public:
    ...
    seDRMDiffuseColour( const seObject &other ) : seDRMBase(other) {}
