...
@brief Accessors to the seDRMLabel (120) class.
*/

#ifndef _seDRMLabel_h
#define _seDRMLabel_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMLabel wraps the DRM <a href="../drm/classes/Label.htm">&lt;Label&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMLabel : public seDRMBase
{
public:
    ...
    seDRMLabel( const seObject &other ) : seDRMBase(other) {}
