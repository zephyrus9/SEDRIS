...
/** @file seDRMFeatureModel.h
@author Warren Macchi (Accent Geographic)
@brief Accessors to the seDRMFeatureModel (75) class.
*/

#ifndef _seDRMFeatureModel_h
#define _seDRMFeatureModel_h

#include "seDRMBase.h"

namespace sedris {

/** seDRMFeatureModel wraps the DRM <a href="../drm/classes/FeatureModel.htm">&lt;Feature_Model&gt;</a> class.
@author Warren Macchi
@version Revision: 1.8
@see seDRMBase
*/
class seDRMFeatureModel : public seDRMBase
{
public:
    ...
    seDRMFeatureModel( const seObject &other ) : seDRMBase(other) {}
