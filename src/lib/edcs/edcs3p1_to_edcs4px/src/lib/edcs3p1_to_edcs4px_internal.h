/*
 * FILE       : edcs3p1_to_edcs4px_internal.h
 *
...
#ifndef _EDCS3P1_TO_EDCS4PX_INTERNAL_H_INCLUDED_
#define _EDCS3P1_TO_EDCS4PX_INTERNAL_H_INCLUDED_
...
/*
 * Global variable defined to determine if
 * EDCS_Init3p1MappingInfo has been called
 * before attempting to map anything.
 */
extern EDCS_Boolean edcs_mapping_initialized;

/*
 * This function allocates all EDCS_3p1_4px_Mapping_Entry structures for
 * those ECs that require them for their mapping types, since we can't reliably statically
 * allocate the union in the EDCS_3p1_4px_Mapping_Entry.
 */
extern EDCS_Status_Code local_init_ec_mapping(void);

extern void local_shutdown_ec_mapping(void);
 ...
 */
int edcs_internal_strcmp( const char * s1, const char * s2 );
