...
##
## Set the BUILDING_SRM_C_API macro.
##
ifndef BUILDING_SRM_C_API
    # Allow BUILDING_SRM_C_API to be specified lowercase
    # Note that if both 'BUILDING_SRM_C_API' and 'building_srm_c_api' are set,
    # the uppercase version has precedence.
	ifdef building_srm_c_api
		BUILDING_SRM_C_API = $(building_srm_c_api)
	else
...
ifdef BUILDING_SRM_C_API
    override BUILDING_SRM_C_API := $(patsubst 0,false,$(BUILDING_SRM_C_API))
    override BUILDING_SRM_C_API := $(patsubst off,false,$(BUILDING_SRM_C_API))
    override BUILDING_SRM_C_API := $(patsubst OFF,false,$(BUILDING_SRM_C_API))
    override BUILDING_SRM_C_API := $(patsubst FALSE,false,$(BUILDING_SRM_C_API))
    override BUILDING_SRM_C_API := $(patsubst no,false,$(BUILDING_SRM_C_API))
    override BUILDING_SRM_C_API := $(patsubst NO,false,$(BUILDING_SRM_C_API))
    ifneq ($(BUILDING_SRM_C_API),false)
        override BUILDING_SRM_C_API = true
    endif
endif
