...
###############################################################################
CC			= cc
MISC_CFLAGS		= -$(OBJECT_FORMAT) -fullwarn 
STD_CFLAGS		= 
OPT_CFLAGS		= -O2 -Olimit 30000
DEBUG_CFLAGS		= -g
PROF_CFLAGS		= -pg
MKDEP_CC		= $(CC)
...
###############################################################################
CXX			= CC
MISC_CXXFLAGS		= -$(OBJECT_FORMAT) -fullwarn -woff 3920,3672 -LANG:exception=OFF -DNAMESPACE=std:: -ptused
STD_CXXFLAGS		= 
OPT_CXXFLAGS		= -O2 -Olimit 30000
DEBUG_CXXFLAGS		= -g
PROF_CXXFLAGS		= -pg
