...
## what will be used during command execution.  If not, the global
...
###################################################################
##
## This is to facilitate building a certain lib with the exported
## symbols arguments.
##
###################################################################
ifeq ($(EXPLICIT_EXPORT),true)
EXPORT_LINE := $(SHARED_LIB_EXPORT_FLAG) $(SRC_DIR)/$(SHARED_LIB_EXPORT_FILE)
else
EXPORT_LINE :=
endif
