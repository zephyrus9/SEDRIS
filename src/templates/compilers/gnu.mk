...
### to a particular compilation environment.  The compilation
...
ifeq (${OSNAME},cygwin32)
	...
	ifeq (${OSNAME},irix)
    		MISC_CFLAGS     = -ansi -fPIC -mabi=n32
	else
...
ifeq (${OSNAME},cygwin32)
	...
	ifeq (${OSNAME},irix)
		...
		-D__ANSI_STRICT_COMPILER__ -mabi=n32 
	else
		MISC_CXXFLAGS           = -fPIC -DNAMESPACE=std:: \
		-D__ANSI_STRICT_COMPILER__ 
	endif
...
##############################################################################
##
## Define macros needed to build shared libraries (also known as dynamic 
...
##############################################################################
##
## Define macros needed to create static libraries (also known as archive 
## libraries, lib's, etc.)
##
##############################################################################
AR			= ar
